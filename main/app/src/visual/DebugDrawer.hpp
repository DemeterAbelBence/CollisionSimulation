...
public:
	...
	static void deleteProgram() { delete program; }
	static void setMode(unsigned int _mode) { mode = _mode; }
	static void setOverrideZ(unsigned int _overrideZ) { overrideZ = _overrideZ; }
